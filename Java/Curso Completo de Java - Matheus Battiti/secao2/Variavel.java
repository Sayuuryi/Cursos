...
public class Variavel {
    ...
    public static void main(String[] args) {
        ...
        //  2 - Atribuição de váriavel com outra
        String teste = "Teste";
        ...
        */
        ...
        // 12 - constantes
        // Você declara uma constante com o metodo final.
        final int DIAS_DA_SEMANA = 7; // Nome das variaveis em constantes TEM QUE SER EM LETRA MAIUSCULA.
