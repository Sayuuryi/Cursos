public class Loops {
    ...
    public static void main(String[] args) {
        ...
        // Condição -> até quando ou quantas vezes, o loop vai rodar
        // incremento -> como a variável vai chegar na condição
        for(int i = 1; i <= 5; i++) {
            // repetir
    ...
    // J -> 0, a -> 3
        ...
        for(int i = 0; i < palavra.length(); i++) {
            ...
            // palavra.chatAt(0) => palavra.charAt(1) ...
            // i < 4
        ...
        // Teste do for para desenhar na tela
        for(int a = 1; a <= 10; a++) {
